        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ ('update-coupon') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" name="coupon_date_start" class="form-control" id="date_start" placeholder="Ngày Bắt Đầu" value="{{ $coupon_old->coupon_date_start }}">
                </div>

                <div class="form-group">
                    <label for="exampleInputName1">Ngày kết thúc</label>
                    <input type="text" autocomplete="off" name="coupon_date_end" class="form-control" id="date_end" placeholder="Ngày Kết Thúc" value="{{ $coupon_old->coupon_date_end }}">
                </div>
